"""
Django settings for hesbon_test_1 project.
...
ROOT_URLCONF = 'hesbon_test_1.urls'
...
WSGI_APPLICATION = 'hesbon_test_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hesbon_test_1 API",
    "DESCRIPTION": "API documentation for hesbon_test_1 App",
    "VERSION": "v1",
}
